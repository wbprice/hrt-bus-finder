...
};b.prototype={cycle:function(b){return b||(this.paused=!1),this.interval&&clearInterval(this.interval),this.options.interval&&!this.paused&&(this.interval=setInterval(a.proxy(this.next,this),this.options.interval)),this},getActiveIndex:function(){return this.$active=this.$element.find(".item.active"),this.$items=this.$active.parent().children(),this.$items.index(this.$active)},to:function(b){var c=this.getActiveIndex(),d=this;if(!(b>this.$items.length-1||0>b))return this.sliding?this.$element.one("slid",function(){d.to(b)}):c==b?this.pause().cycle():this.slide(b>c?"next":"prev",a(this.$items[b]))},pause:function(b){return b||(this.paused=!0),this.$element.find(".next, .prev").length&&a.support.transition.end&&(this.$element.trigger(a.support.transition.end),this.cycle(!0)),clearInterval(this.interval),this.interval=null,this},next:function(){return this.sliding?void 0:this.slide("next")},prev:function(){return this.sliding?void 0:this.slide("prev")},slide:function(b,c){var d,e=this.$element.find(".item.active"),f=c||e[b](),g=this.interval,h="next"==b?"left":"right",i="next"==b?"first":"last",j=this;if(this.sliding=!0,g&&this.pause(),f=f.length?f:this.$element.find(".item")[i](),d=a.Event("slide",{relatedTarget:f[0],direction:h}),!f.hasClass("active")){if(this.$indicators.length&&(this.$indicators.find(".active").removeClass("active"),this.$element.one("slid",function(){var b=a(j.$indicators.children()[j.getActiveIndex()]);b&&b.addClass("active")})),a.support.transition&&this.$element.hasClass("slide")){if(this.$element.trigger(d),d.isDefaultPrevented())return;f.addClass(b),f[0].offsetWidth,e.addClass(h),f.addClass(h),this.$element.one(a.support.transition.end,function(){f.removeClass([b,h].join(" ")).addClass("active"),e.removeClass(["active",h].join(" ")),j.sliding=!1,setTimeout(function(){j.$element.trigger("slid")},0)})}else{if(this.$element.trigger(d),d.isDefaultPrevented())return;e.removeClass("active"),f.addClass("active"),this.sliding=!1,this.$element.trigger("slid")}return g&&this.cycle(),this}}};var c=a.fn.carousel;a.fn.carousel=function(c){return this.each(function(){var d=a(this),e=d.data("carousel"),f=a.extend({},a.fn.carousel.defaults,"object"==typeof c&&c),g="string"==typeof c?c:f.slide;e||d.data("carousel",e=new b(this,f)),"number"==typeof c?e.to(c):g?e[g]():f.interval&&e.pause().cycle()})},a.fn.carousel.defaults={interval:5e3,pause:"hover"},a.fn.carousel.Constructor=b,a.fn.carousel.noConflict=function(){return a.fn.carousel=c,this},a(document).on("click.carousel.data-api","[data-slide], [data-slide-to]",function(b){var c,d,e=a(this),f=a(e.attr("data-target")||(c=e.attr("href"))&&c.replace(/.*(?=#[^\s]+$)/,"")),g=a.extend({},f.data(),e.data());f.carousel(g),(d=e.attr("data-slide-to"))&&f.data("carousel").pause().to(d).cycle(),b.preventDefault()})}(window.jQuery),!function(a){"use strict";var b=function(b,c){this.$element=a(b),this.options=a.extend({},a.fn.collapse.defaults,c),this.options.parent&&(this.$parent=a(this.options.parent)),this.options.toggle&&this.toggle()};b.prototype={constructor:b,dimension:function(){var a=this.$element.hasClass("width");return a?"width":"height"},show:function(){var b,c,d,e;if(!this.transitioning&&!this.$element.hasClass("in")){if(b=this.dimension(),c=a.camelCase(["scroll",b].join("-")),d=this.$parent&&this.$parent.find("> .accordion-group > .in"),d&&d.length){if(e=d.data("collapse"),e&&e.transitioning)return;d.collapse("hide"),e||d.data("collapse",null)}this.$element[b](0),this.transition("addClass",a.Event("show"),"shown"),a.support.transition&&this.$element[b](this.$element[0][c])}},hide:function(){var b;!this.transitioning&&this.$element.hasClass("in")&&(b=this.dimension(),this.reset(this.$element[b]()),this.transition("removeClass",a.Event("hide"),"hidden"),this.$element[b](0))},reset:function(a){var b=this.dimension();return this.$element.removeClass("collapse")[b](a||"auto")[0].offsetWidth,this.$element[null!==a?"addClass":"removeClass"]("collapse"),this},transition:function(b,c,d){var e=this,f=function(){"show"==c.type&&e.reset(),e.transitioning=0,e.$element.trigger(d)};this.$element.trigger(c),c.isDefaultPrevented()||(this.transitioning=1,this.$element[b]("in"),a.support.transition&&this.$element.hasClass("collapse")?this.$element.one(a.support.transition.end,f):f())},toggle:function(){this[this.$element.hasClass("in")?"hide":"show"]()}};var c=a.fn.collapse;a.fn.collapse=function(c){return this.each(function(){var d=a(this),e=d.data("collapse"),f=a.extend({},a.fn.collapse.defaults,d.data(),"object"==typeof c&&c);e||d.data("collapse",e=new b(this,f)),"string"==typeof c&&e[c]()})},a.fn.collapse.defaults={toggle:!0},a.fn.collapse.Constructor=b,a.fn.collapse.noConflict=function(){return a.fn.collapse=c,this},a(document).on("click.collapse.data-api","[data-toggle=collapse]",function(b){var c,d=a(this),e=d.attr("data-target")||b.preventDefault()||(c=d.attr("href"))&&c.replace(/.*(?=#[^\s]+$)/,""),f=a(e).data("collapse")?"toggle":d.data();d[a(e).hasClass("in")?"addClass":"removeClass"]("collapsed"),a(e).collapse(f)})}(window.jQuery),!function(a){"use strict";function b(){a(".dropdown-backdrop").remove(),a(d).each(function(){c(a(this)).removeClass("open")})}function c(b){var c,d=b.attr("data-target");return d||(d=b.attr("href"),d=d&&/#/.test(d)&&d.replace(/.*(?=#[^\s]*$)/,"")),c=d&&a(d),c&&c.length||(c=b.parent()),c}var d="[data-toggle=dropdown]",e=function(b){var c=a(b).on("click.dropdown.data-api",this.toggle);a("html").on("click.dropdown.data-api",function(){c.parent().removeClass("open")})};e.prototype={constructor:e,toggle:function(){var d,e,f=a(this);if(!f.is(".disabled, :disabled"))return d=c(f),e=d.hasClass("open"),b(),e||("ontouchstart"in document.documentElement&&a('<div class="dropdown-backdrop"/>').insertBefore(a(this)).on("click",b),d.toggleClass("open")),f.focus(),!1},keydown:function(b){var e,f,g,h,i;if(/(38|40|27)/.test(b.keyCode)&&(e=a(this),b.preventDefault(),b.stopPropagation(),!e.is(".disabled, :disabled"))){if(g=c(e),h=g.hasClass("open"),!h||h&&27==b.keyCode)return 27==b.which&&g.find(d).focus(),e.click();f=a("[role=menu] li:not(.divider):visible a",g),f.length&&(i=f.index(f.filter(":focus")),38==b.keyCode&&i>0&&i--,40==b.keyCode&&i<f.length-1&&i++,~i||(i=0),f.eq(i).focus())}}};var f=a.fn.dropdown;a.fn.dropdown=function(b){return this.each(function(){var c=a(this),d=c.data("dropdown");d||c.data("dropdown",d=new e(this)),"string"==typeof b&&d[b].call(c)})},a.fn.dropdown.Constructor=e,a.fn.dropdown.noConflict=function(){return a.fn.dropdown=f,this},a(document).on("click.dropdown.data-api",b).on("click.dropdown.data-api",".dropdown form",function(a){a.stopPropagation()}).on("click.dropdown.data-api",d,e.prototype.toggle).on("keydown.dropdown.data-api",d+", [role=menu]",e.prototype.keydown)}(window.jQuery),!function(a){"use strict";var b=function(b,c){this.options=c,this.$element=a(b).delegate('[data-dismiss="modal"]',"click.dismiss.modal",a.proxy(this.hide,this)),this.options.remote&&this.$element.find(".modal-body").load(this.options.remote)};b.prototype={constructor:b,toggle:function(){return this[this.isShown?"hide":"show"]()},show:function(){var b=this,c=a.Event("show");this.$element.trigger(c),this.isShown||c.isDefaultPrevented()||(this.isShown=!0,this.escape(),this.backdrop(function(){var c=a.support.transition&&b.$element.hasClass("fade");b.$element.parent().length||b.$element.appendTo(document.body),b.$element.show(),c&&b.$element[0].offsetWidth,b.$element.addClass("in").attr("aria-hidden",!1),b.enforceFocus(),c?b.$element.one(a.support.transition.end,function(){b.$element.focus().trigger("shown")}):b.$element.focus().trigger("shown")}))},hide:function(b){b&&b.preventDefault();b=a.Event("hide"),this.$element.trigger(b),this.isShown&&!b.isDefaultPrevented()&&(this.isShown=!1,this.escape(),a(document).off("focusin.modal"),this.$element.removeClass("in").attr("aria-hidden",!0),a.support.transition&&this.$element.hasClass("fade")?this.hideWithTransition():this.hideModal())},enforceFocus:function(){var b=this;a(document).on("focusin.modal",function(a){b.$element[0]!==a.target&&!b.$element.has(a.target).length&&b.$element.focus()})},escape:function(){var a=this;this.isShown&&this.options.keyboard?this.$element.on("keyup.dismiss.modal",function(b){27==b.which&&a.hide()}):this.isShown||this.$element.off("keyup.dismiss.modal")},hideWithTransition:function(){var b=this,c=setTimeout(function(){b.$element.off(a.support.transition.end),b.hideModal()},500);this.$element.one(a.support.transition.end,function(){clearTimeout(c),b.hideModal()})},hideModal:function(){var a=this;this.$element.hide(),this.backdrop(function(){a.removeBackdrop(),a.$element.trigger("hidden")})},removeBackdrop:function(){this.$backdrop&&this.$backdrop.remove(),this.$backdrop=null},backdrop:function(b){var c=this.$element.hasClass("fade")?"fade":"";if(this.isShown&&this.options.backdrop){var d=a.support.transition&&c;if(this.$backdrop=a('<div class="modal-backdrop '+c+'" />').appendTo(document.body),this.$backdrop.click("static"==this.options.backdrop?a.proxy(this.$element[0].focus,this.$element[0]):a.proxy(this.hide,this)),d&&this.$backdrop[0].offsetWidth,this.$backdrop.addClass("in"),!b)return;d?this.$backdrop.one(a.support.transition.end,b):b()}else!this.isShown&&this.$backdrop?(this.$backdrop.removeClass("in"),a.support.transition&&this.$element.hasClass("fade")?this.$backdrop.one(a.support.transition.end,b):b()):b&&b()}};var c=a.fn.modal;a.fn.modal=function(c){return this.each(function(){var d=a(this),e=d.data("modal"),f=a.extend({},a.fn.modal.defaults,d.data(),"object"==typeof c&&c);e||d.data("modal",e=new b(this,f)),"string"==typeof c?e[c]():f.show&&e.show()})},a.fn.modal.defaults={backdrop:!0,keyboard:!0,show:!0},a.fn.modal.Constructor=b,a.fn.modal.noConflict=function(){return a.fn.modal=c,this},a(document).on("click.modal.data-api",'[data-toggle="modal"]',function(b){var c=a(this),d=c.attr("href"),e=a(c.attr("data-target")||d&&d.replace(/.*(?=#[^\s]+$)/,"")),f=e.data("modal")?"toggle":a.extend({remote:!/#/.test(d)&&d},e.data(),c.data());b.preventDefault(),e.modal(f).one("hide",function(){c.focus()})})}(window.jQuery),!function(a){"use strict";var b=function(a,b){this.init("tooltip",a,b)};b.prototype={constructor:b,init:function(b,c,d){var e,f,g,h,i;for(this.type=b,this.$element=a(c),this.options=this.getOptions(d),this.enabled=!0,g=this.options.trigger.split(" "),i=g.length;i--;)h=g[i],"click"==h?this.$element.on("click."+this.type,this.options.selector,a.proxy(this.toggle,this)):"manual"!=h&&(e="hover"==h?"mouseenter":"focus",f="hover"==h?"mouseleave":"blur",this.$element.on(e+"."+this.type,this.options.selector,a.proxy(this.enter,this)),this.$element.on(f+"."+this.type,this.options.selector,a.proxy(this.leave,this)));this.options.selector?this._options=a.extend({},this.options,{trigger:"manual",selector:""}):this.fixTitle()},getOptions:function(b){return b=a.extend({},a.fn[this.type].defaults,this.$element.data(),b),b.delay&&"number"==typeof b.delay&&(b.delay={show:b.delay,hide:b.delay}),b},enter:function(b){var c,d=a.fn[this.type].defaults,e={};return this._options&&a.each(this._options,function(a,b){d[a]!=b&&(e[a]=b)},this),c=a(b.currentTarget)[this.type](e).data(this.type),c.options.delay&&c.options.delay.show?(clearTimeout(this.timeout),c.hoverState="in",this.timeout=setTimeout(function(){"in"==c.hoverState&&c.show()},c.options.delay.show),void 0):c.show()},leave:function(b){var c=a(b.currentTarget)[this.type](this._options).data(this.type);return this.timeout&&clearTimeout(this.timeout),c.options.delay&&c.options.delay.hide?(c.hoverState="out",this.timeout=setTimeout(function(){"out"==c.hoverState&&c.hide()},c.options.delay.hide),void 0):c.hide()},show:function(){var b,c,d,e,f,g,h=a.Event("show");if(this.hasContent()&&this.enabled){if(this.$element.trigger(h),h.isDefaultPrevented())return;switch(b=this.tip(),this.setContent(),this.options.animation&&b.addClass("fade"),f="function"==typeof this.options.placement?this.options.placement.call(this,b[0],this.$element[0]):this.options.placement,b.detach().css({top:0,left:0,display:"block"}),this.options.container?b.appendTo(this.options.container):b.insertAfter(this.$element),c=this.getPosition(),d=b[0].offsetWidth,e=b[0].offsetHeight,f){case"bottom":g={top:c.top+c.height,left:c.left+c.width/2-d/2};break;case"top":g={top:c.top-e,left:c.left+c.width/2-d/2};break;case"left":g={top:c.top+c.height/2-e/2,left:c.left-d};break;case"right":g={top:c.top+c.height/2-e/2,left:c.left+c.width}}this.applyPlacement(g,f),this.$element.trigger("shown")}},applyPlacement:function(a,b){var c,d,e,f,g=this.tip(),h=g[0].offsetWidth,i=g[0].offsetHeight;g.offset(a).addClass(b).addClass("in"),c=g[0].offsetWidth,d=g[0].offsetHeight,"top"==b&&d!=i&&(a.top=a.top+i-d,f=!0),"bottom"==b||"top"==b?(e=0,a.left<0&&(e=-2*a.left,a.left=0,g.offset(a),c=g[0].offsetWidth,d=g[0].offsetHeight),this.replaceArrow(e-h+c,c,"left")):this.replaceArrow(d-i,d,"top"),f&&g.offset(a)},replaceArrow:function(a,b,c){this.arrow().css(c,a?50*(1-a/b)+"%":"")},setContent:function(){var a=this.tip(),b=this.getTitle();a.find(".tooltip-inner")[this.options.html?"html":"text"](b),a.removeClass("fade in top bottom left right")},hide:function(){function b(){var b=setTimeout(function(){c.off(a.support.transition.end).detach()},500);c.one(a.support.transition.end,function(){clearTimeout(b),c.detach()})}var c=this.tip(),d=a.Event("hide");return this.$element.trigger(d),d.isDefaultPrevented()?void 0:(c.removeClass("in"),a.support.transition&&this.$tip.hasClass("fade")?b():c.detach(),this.$element.trigger("hidden"),this)},fixTitle:function(){var a=this.$element;(a.attr("title")||"string"!=typeof a.attr("data-original-title"))&&a.attr("data-original-title",a.attr("title")||"").attr("title","")},hasContent:function(){return this.getTitle()},getPosition:function(){var b=this.$element[0];return a.extend({},"function"==typeof b.getBoundingClientRect?b.getBoundingClientRect():{width:b.offsetWidth,height:b.offsetHeight},this.$element.offset())},getTitle:function(){var a,b=this.$element,c=this.options;return a=b.attr("data-original-title")||("function"==typeof c.title?c.title.call(b[0]):c.title)},tip:function(){return this.$tip=this.$tip||a(this.options.template)},arrow:function(){return this.$arrow=this.$arrow||this.tip().find(".tooltip-arrow")},validate:function(){this.$element[0].parentNode||(this.hide(),this.$element=null,this.options=null)},enable:function(){this.enabled=!0},disable:function(){this.enabled=!1},toggleEnabled:function(){this.enabled=!this.enabled},toggle:function(b){var c=b?a(b.currentTarget)[this.type](this._options).data(this.type):this;c.tip().hasClass("in")?c.hide():c.show()},destroy:function(){this.hide().$element.off("."+this.type).removeData(this.type)}};var c=a.fn.tooltip;a.fn.tooltip=function(c){return this.each(function(){var d=a(this),e=d.data("tooltip"),f="object"==typeof c&&c;e||d.data("tooltip",e=new b(this,f)),"string"==typeof c&&e[c]()})},a.fn.tooltip.Constructor=b,a.fn.tooltip.defaults={animation:!0,placement:"top",selector:!1,template:'<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',trigger:"hover focus",title:"",delay:0,html:!1,container:!1},a.fn.tooltip.noConflict=function(){return a.fn.tooltip=c,this}}(window.jQuery),!function(a){"use strict";var b=function(a,b){this.init("popover",a,b)};b.prototype=a.extend({},a.fn.tooltip.Constructor.prototype,{constructor:b,setContent:function(){var a=this.tip(),b=this.getTitle(),c=this.getContent();a.find(".popover-title")[this.options.html?"html":"text"](b),a.find(".popover-content")[this.options.html?"html":"text"](c),a.removeClass("fade top bottom left right in")},hasContent:function(){return this.getTitle()||this.getContent()},getContent:function(){var a,b=this.$element,c=this.options;return a=("function"==typeof c.content?c.content.call(b[0]):c.content)||b.attr("data-content")},tip:function(){return this.$tip||(this.$tip=a(this.options.template)),this.$tip},destroy:function(){this.hide().$element.off("."+this.type).removeData(this.type)}});var c=a.fn.popover;a.fn.popover=function(c){return this.each(function(){var d=a(this),e=d.data("popover"),f="object"==typeof c&&c;e||d.data("popover",e=new b(this,f)),"string"==typeof c&&e[c]()})},a.fn.popover.Constructor=b,a.fn.popover.defaults=a.extend({},a.fn.tooltip.defaults,{placement:"right",trigger:"click",content:"",template:'<div class="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'}),a.fn.popover.noConflict=function(){return a.fn.popover=c,this}}(window.jQuery),!function(a){"use strict";function b(b,c){var d,e=a.proxy(this.process,this),f=a(b).is("body")?a(window):a(b);this.options=a.extend({},a.fn.scrollspy.defaults,c),this.$scrollElement=f.on("scroll.scroll-spy.data-api",e),this.selector=(this.options.target||(d=a(b).attr("href"))&&d.replace(/.*(?=#[^\s]+$)/,"")||"")+" .nav li > a",this.$body=a("body"),this.refresh(),this.process()}b.prototype={constructor:b,refresh:function(){var b,c=this;this.offsets=a([]),this.targets=a([]),b=this.$body.find(this.selector).map(function(){var b=a(this),d=b.data("target")||b.attr("href"),e=/^#\w/.test(d)&&a(d);return e&&e.length&&[[e.position().top+(!a.isWindow(c.$scrollElement.get(0))&&c.$scrollElement.scrollTop()),d]]||null}).sort(function(a,b){return a[0]-b[0]}).each(function(){c.offsets.push(this[0]),c.targets.push(this[1])})},process:function(){var a,b=this.$scrollElement.scrollTop()+this.options.offset,c=this.$scrollElement[0].scrollHeight||this.$body[0].scrollHeight,d=c-this.$scrollElement.height(),e=this.offsets,f=this.targets,g=this.activeTarget;if(b>=d)return g!=(a=f.last()[0])&&this.activate(a);for(a=e.length;a--;)g!=f[a]&&b>=e[a]&&(!e[a+1]||b<=e[a+1])&&this.activate(f[a])},activate:function(b){var c,d;this.activeTarget=b,a(this.selector).parent(".active").removeClass("active"),d=this.selector+'[data-target="'+b+'"],'+this.selector+'[href="'+b+'"]',c=a(d).parent("li").addClass("active"),c.parent(".dropdown-menu").length&&(c=c.closest("li.dropdown").addClass("active")),c.trigger("activate")}};var c=a.fn.scrollspy;a.fn.scrollspy=function(c){return this.each(function(){var d=a(this),e=d.data("scrollspy"),f="object"==typeof c&&c;e||d.data("scrollspy",e=new b(this,f)),"string"==typeof c&&e[c]()})},a.fn.scrollspy.Constructor=b,a.fn.scrollspy.defaults={offset:10},a.fn.scrollspy.noConflict=function(){return a.fn.scrollspy=c,this},a(window).on("load",function(){a('[data-spy="scroll"]').each(function(){var b=a(this);b.scrollspy(b.data())})})}(window.jQuery),!function(a){"use strict";var b=function(b){this.element=a(b)};b.prototype={constructor:b,show:function(){var b,c,d,e=this.element,f=e.closest("ul:not(.dropdown-menu)"),g=e.attr("data-target");g||(g=e.attr("href"),g=g&&g.replace(/.*(?=#[^\s]*$)/,"")),e.parent("li").hasClass("active")||(b=f.find(".active:last a")[0],d=a.Event("show",{relatedTarget:b}),e.trigger(d),d.isDefaultPrevented()||(c=a(g),this.activate(e.parent("li"),f),this.activate(c,c.parent(),function(){e.trigger({type:"shown",relatedTarget:b})})))},activate:function(b,c,d){function e(){f.removeClass("active").find("> .dropdown-menu > .active").removeClass("active"),b.addClass("active"),g?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade"),b.parent(".dropdown-menu")&&b.closest("li.dropdown").addClass("active"),d&&d()}var f=c.find("> .active"),g=d&&a.support.transition&&f.hasClass("fade");g?f.one(a.support.transition.end,e):e(),f.removeClass("in")}};var c=a.fn.tab;a.fn.tab=function(c){return this.each(function(){var d=a(this),e=d.data("tab");e||d.data("tab",e=new b(this)),"string"==typeof c&&e[c]()})},a.fn.tab.Constructor=b,a.fn.tab.noConflict=function(){return a.fn.tab=c,this},a(document).on("click.tab.data-api",'[data-toggle="tab"], [data-toggle="pill"]',function(b){b.preventDefault(),a(this).tab("show")})}(window.jQuery),!function(a){"use strict";var b=function(b,c){this.$element=a(b),this.options=a.extend({},a.fn.typeahead.defaults,c),this.matcher=this.options.matcher||this.matcher,this.sorter=this.options.sorter||this.sorter,this.highlighter=this.options.highlighter||this.highlighter,this.updater=this.options.updater||this.updater,this.source=this.options.source,this.$menu=a(this.options.menu),this.shown=!1,this.listen()};b.prototype={constructor:b,select:function(){var a=this.$menu.find(".active").attr("data-value");return this.$element.val(this.updater(a)).change(),this.hide()},updater:function(a){return a},show:function(){var b=a.extend({},this.$element.position(),{height:this.$element[0].offsetHeight});return this.$menu.insertAfter(this.$element).css({top:b.top+b.height,left:b.left}).show(),this.shown=!0,this},hide:function(){return this.$menu.hide(),this.shown=!1,this},lookup:function(){var b;return this.query=this.$element.val(),!this.query||this.query.length<this.options.minLength?this.shown?this.hide():this:(b=a.isFunction(this.source)?this.source(this.query,a.proxy(this.process,this)):this.source,b?this.process(b):this)},process:function(b){var c=this;return b=a.grep(b,function(a){return c.matcher(a)}),b=this.sorter(b),b.length?this.render(b.slice(0,this.options.items)).show():this.shown?this.hide():this},matcher:function(a){return~a.toLowerCase().indexOf(this.query.toLowerCase())},sorter:function(a){for(var b,c=[],d=[],e=[];b=a.shift();)b.toLowerCase().indexOf(this.query.toLowerCase())?~b.indexOf(this.query)?d.push(b):e.push(b):c.push(b);return c.concat(d,e)},highlighter:function(a){var b=this.query.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&");return a.replace(new RegExp("("+b+")","ig"),function(a,b){return"<strong>"+b+"</strong>"})},render:function(b){var c=this;return b=a(b).map(function(b,d){return b=a(c.options.item).attr("data-value",d),b.find("a").html(c.highlighter(d)),b[0]}),b.first().addClass("active"),this.$menu.html(b),this},next:function(){var b=this.$menu.find(".active").removeClass("active"),c=b.next();c.length||(c=a(this.$menu.find("li")[0])),c.addClass("active")},prev:function(){var a=this.$menu.find(".active").removeClass("active"),b=a.prev();b.length||(b=this.$menu.find("li").last()),b.addClass("active")},listen:function(){this.$element.on("focus",a.proxy(this.focus,this)).on("blur",a.proxy(this.blur,this)).on("keypress",a.proxy(this.keypress,this)).on("keyup",a.proxy(this.keyup,this)),this.eventSupported("keydown")&&this.$element.on("keydown",a.proxy(this.keydown,this)),this.$menu.on("click",a.proxy(this.click,this)).on("mouseenter","li",a.proxy(this.mouseenter,this)).on("mouseleave","li",a.proxy(this.mouseleave,this))},eventSupported:function(a){var b=a in this.$element;return b||(this.$element.setAttribute(a,"return;"),b="function"==typeof this.$element[a]),b},move:function(a){if(this.shown){switch(a.keyCode){case 9:case 13:case 27:a.preventDefault();break;case 38:a.preventDefault(),this.prev();break;case 40:a.preventDefault(),this.next()}a.stopPropagation()}},keydown:function(b){this.suppressKeyPressRepeat=~a.inArray(b.keyCode,[40,38,9,13,27]),this.move(b)},keypress:function(a){this.suppressKeyPressRepeat||this.move(a)},keyup:function(a){switch(a.keyCode){case 40:case 38:case 16:case 17:case 18:break;case 9:case 13:if(!this.shown)return;this.select();break;case 27:if(!this.shown)return;this.hide();break;default:this.lookup()}a.stopPropagation(),a.preventDefault()},focus:function(){this.focused=!0},blur:function(){this.focused=!1,!this.mousedover&&this.shown&&this.hide()},click:function(a){a.stopPropagation(),a.preventDefault(),this.select(),this.$element.focus()},mouseenter:function(b){this.mousedover=!0,this.$menu.find(".active").removeClass("active"),a(b.currentTarget).addClass("active")},mouseleave:function(){this.mousedover=!1,!this.focused&&this.shown&&this.hide()}};var c=a.fn.typeahead;a.fn.typeahead=function(c){return this.each(function(){var d=a(this),e=d.data("typeahead"),f="object"==typeof c&&c;e||d.data("typeahead",e=new b(this,f)),"string"==typeof c&&e[c]()})},a.fn.typeahead.defaults={source:[],items:8,menu:'<ul class="typeahead dropdown-menu"></ul>',item:'<li><a href="#"></a></li>',minLength:1},a.fn.typeahead.Constructor=b,a.fn.typeahead.noConflict=function(){return a.fn.typeahead=c,this},a(document).on("focus.typeahead.data-api",'[data-provide="typeahead"]',function(){var b=a(this);b.data("typeahead")||b.typeahead(b.data())})}(window.jQuery),!function(a){"use strict";var b=function(b,c){this.options=a.extend({},a.fn.affix.defaults,c),this.$window=a(window).on("scroll.affix.data-api",a.proxy(this.checkPosition,this)).on("click.affix.data-api",a.proxy(function(){setTimeout(a.proxy(this.checkPosition,this),1)},this)),this.$element=a(b),this.checkPosition()};b.prototype.checkPosition=function(){if(this.$element.is(":visible")){var b,c=a(document).height(),d=this.$window.scrollTop(),e=this.$element.offset(),f=this.options.offset,g=f.bottom,h=f.top,i="affix affix-top affix-bottom";"object"!=typeof f&&(g=h=f),"function"==typeof h&&(h=f.top()),"function"==typeof g&&(g=f.bottom()),b=null!=this.unpin&&d+this.unpin<=e.top?!1:null!=g&&e.top+this.$element.height()>=c-g?"bottom":null!=h&&h>=d?"top":!1,this.affixed!==b&&(this.affixed=b,this.unpin="bottom"==b?e.top-d:null,this.$element.removeClass(i).addClass("affix"+(b?"-"+b:"")))}};var c=a.fn.affix;a.fn.affix=function(c){return this.each(function(){var d=a(this),e=d.data("affix"),f="object"==typeof c&&c;e||d.data("affix",e=new b(this,f)),"string"==typeof c&&e[c]()})},a.fn.affix.Constructor=b,a.fn.affix.defaults={offset:0},a.fn.affix.noConflict=function(){return a.fn.affix=c,this},a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var b=a(this),c=b.data();c.offset=c.offset||{},c.offsetBottom&&(c.offset.bottom=c.offsetBottom),c.offsetTop&&(c.offset.top=c.offsetTop),b.affix(c)})})}(window.jQuery),$(function(){var a=Backbone.Model.extend({idAttribute:"_id",date:function(){return new Date(Date.parseUtc(this.get("arrival_time")))},localTime:function(){return this.date().to12HourString()},minutesFromNow:function(){var a=this.date();this.get("busAdherence")&&(a=a.addMinutes(-1*this.get("busAdherence")));var b=new Date(a-(new Date).getTime());return b.getTime()/1e3/60|0},adherenceDescription:function(){if(!this.has("busAdherence"))return"scheduled";var a=this.get("busAdherence");return a>0?a+" min early":0>a?-1*a+" min late":"on time"},lastCheckinTimeDescription:function(){if(!this.has("busCheckinTime"))return"";var a=new Date(Date.parseUtc(this.get("busCheckinTime"))),b=new Date((new Date).getTime()-a).getTime()/1e3/60|0;return 0==b?"just now":1==b?"1 minute ago":b+" minutes ago"}}),b=Backbone.Model.extend({idAttribute:"_id"}),c="http://lit-inlet-3610.herokuapp.com/api/",d=Backbone.Collection.extend({model:a,comparator:function(a){return a.minutesFromNow()},url:function(){return c+"stop_times/"+this.stopId+"/"}}),e=Backbone.Collection.extend({url:function(){return this.location?c+"stops/near/"+this.location.lat()+"/"+this.location.lng()+"/":this.stopIds?c+"stops/id/"+this.stopIds+"/":void 0}}),f=(Backbone.Model.extend({defaults:{name:"",emailAddress:"",message:""},validate:function(a){return void 0===a.message?"A message was not included.":void 0}}),Backbone.Collection.extend({initialize:function(a,b){this.routeIds=b.routeIds},url:function(){var a=c+"buses/routes";return this.routeIds&&(a+="/"+this.routeIds+"/"),a}})),g=Backbone.Collection.extend({url:c+"routes/active/"}),h=Backbone.View.extend({initialize:function(){this.collection.on("reset",this.render,this),this.collection.fetch({reset:!0,dataType:"jsonp"})},render:function(){$("#loading").remove(),this.collection.each(this.addStop,this)},addStop:function(a){var b=new i({model:a});this.$el.append(b.render().$el)}}),i=Backbone.View.extend({template:_.template($("#stop-template").html()),initialize:function(){this.collection=new d,this.collection.stopId=this.model.get("stopId"),this.collection.on("add",this.addArrival,this),this.collection.on("sort",this.checkOrder,this),this.collection.on("sync",this.checkForEmpty,this),this.listenTo(v.ContentView,"forceRefresh",this.updateArrivalList),this.updateArrivalList(),v.Intervals.push(setInterval($.proxy(this.updateArrivalList,this),6e4))},updateArrivalList:function(){this.collection.fetch({dataType:"jsonp"})},render:function(){return this.$el.html(this.template(this.model.toJSON())),this},checkForEmpty:function(){if(!this.collection.length){var a=$("<div/>",{text:"No scheduled stops"});a.addClass("no-arrivals"),this.$(".arrivals").html(a)}},checkOrder:function(){var a=this.$(".arrivals .table .schedule");if(a.length!=this.collection.length)return this.addAllArrivals(),void 0;for(var b=0;b<this.collection.length;b++)if($(a[b]).attr("data-id")!=this.collection.at(b).id)return this.addAllArrivals(),void 0},addAllArrivals:function(){this.$(".arrivals .table").empty(),this.collection.each(this.addArrival,this)},addArrival:function(a){var b=new k({model:a,stop:this.model});this.$(".arrivals .table").append(b.render().$el)}}),j=Backbone.View.extend({initialize:function(){this.map=new google.maps.Map(this.$el[0],{disableDefaultUI:!0,styles:[{featureType:"poi",stylers:[{visibility:"off"}]}]}),this.markers=[],this.busMarkers={},this.oldBusMarkers={},google.maps.event.addListener(this.map,"dragstart",$.proxy(this.cancelCenterChanged,this)),google.maps.event.addListener(this.map,"dragend",$.proxy(this.readyCenterChanged,this))},setOnCenterChangedEvent:function(a){this.onCenterChanged=a},readyCenterChanged:function(){this.centerChangedTimeout=setTimeout($.proxy(this.centerChanged,this),1e3)},cancelCenterChanged:function(){this.centerChangedTimeout&&clearTimeout(this.centerChangedTimeout)},centerChanged:function(){this.onCenterChanged&&this.onCenterChanged(this.map.getCenter())},clear:function(){for(this.setOnCenterChangedEvent(null);this.markers.length;)this.markers.pop().setMap(null);this.oldBusMarkers=this.busMarkers,this.busMarkers={},$.each(this.oldBusMarkers,function(a,b){b.setMap(null)})},createUserMarker:function(a,b){var c=new google.maps.Marker({position:a,animation:b&&google.maps.Animation.DROP,map:this.map});this.markers.push(c)},createStopMarker:function(a,b,c){var d=new google.maps.LatLng(a.get("location")[1],a.get("location")[0]),e=new google.maps.Marker({position:d,animation:b&&google.maps.Animation.DROP,map:this.map,icon:"./img/busstop.png"});c&&google.maps.event.addListener(e,"click",c),this.markers.push(e)},createBusMarker:function(a){var b=a.get("busPosition")||a.get("location"),c=a.get("direction_id")||a.get("direction");if(b){var d=new google.maps.LatLng(b[1],b[0]),e=c?"inbound":"outbound",f="./img/bus-"+e+".png",g=new google.maps.Marker({position:d,icon:f});if(a.get("busId")in this.oldBusMarkers?this.moveMarker(this.oldBusMarkers[a.get("busId")],g):g.setMap(this.map),a.has("location")){var h=new google.maps.InfoWindow({content:this.getInfoWindowMsg(a)});this.setupInfoWindow(g,h)}this.busMarkers[a.get("busId")]=g}},setupInfoWindow:function(a,b){var c=this.map;google.maps.event.addListener(a,"click",function(){b.open(c,a)})},getInfoWindowMsg:function(a){var b="";b+="Bus #"+a.get("busId")+" traveling ",b+=0==a.get("direction")?"outbound":"inbound";var c=a.get("adherence");null!=c&&(b+="<br>is "),b+=null==c?"<br>has no adherence":0==c?"on time":1==c?"1 minute early":c>0?c+" minutes early":-1==c?"1 minute late":-1*c+" minutes late";var d=new Date(Date.parseUtc(a.get("time"))),e=new Date((new Date).getTime()-d).getTime()/1e3/60|0;return b+="<br>as of ",b+=0==e?"just now.":1==e?"1 minute ago.":e+" minutes ago."},moveMarker:function(a,b){var c=50,d=a.getPosition(),e=b.getPosition();if(d.lat()==e.lat()&&d.lng()==e.lng())return b.setMap(this.map),void 0;var f=(e.lat()-d.lat())/c,g=(e.lng()-d.lng())/c;b.setPosition(d),b.setMap(this.map),(move=function(a,b,d,e,f){var g=b.getPosition(),h=new google.maps.LatLng(g.lat()+d,g.lng()+e);b.setPosition(h),c>a?setTimeout(function(){move(a+1,b,d,e,f)},100):b.setPosition(f)})(1,b,f,g,e)},setBounds:function(){for(var a=new google.maps.LatLngBounds,b=0;b<this.markers.length;b++)a.extend(this.markers[b].getPosition());
$.each(this.busMarkers,function(b,c){a.extend(c.getPosition())}),this.map.fitBounds(a)},center:function(a){return a?(this.map.setCenter(a),void 0):this.map.getCenter()},resize:function(){google.maps.event.trigger(this.map,"resize")},zoom:function(a){this.map.setZoom(a)},setDraggable:function(a){this.map.setOptions({draggable:a,scrollwheel:a,disableDoubleClickZoom:!a})}}),k=Backbone.View.extend({className:"schedule row-fluid",template:_.template($("#arrival-template").html()),events:{"click .row-fluid":"showMap","click .arrow":"showMap"},routeType:{0:"light-rail",3:"bus",4:"ferry"},initialize:function(){this.model.on("change",this.render,this),this.model.on("remove",this.remove,this),$(window).resize($.proxy(this.resize,this)),v.Intervals.push(setInterval($.proxy(this.updateTime,this),1e4))},updateTime:function(){var a=this.model.minutesFromNow();this.$(".timeframe").html(this.minutesFromNowToString(a)),this.$(".lastUpdate").html(this.model.lastCheckinTimeDescription()),this.$(".timeframe").removeClass("departed imminent enroute"),0>a?this.$(".timeframe").addClass("departed"):a>=0&&5>=a?this.$(".timeframe").addClass("imminent"):this.$(".timeframe").addClass("enroute")},minutesFromNowToString:function(a){return 0==a?"Now":0>a?"Gone":a},render:function(){var a=this.$(".mapcanvas").is(":visible"),b=this.model.minutesFromNow();return this.$el.html(this.template({routeId:this.model.get("route_id"),destination:this.model.get("destination"),arriveTime:this.model.localTime(),adherence:this.model.adherenceDescription(),arriveMinutes:this.minutesFromNowToString(b),busId:this.model.get("busId"),lastUpdate:this.model.lastCheckinTimeDescription()})),this.updateTime(),this.$el.attr("data-id",this.model.id),this.$el.addClass(this.routeType[this.model.get("routeType")]+"-route"),a&&this.showMap(null),this},showMap:function(a){var b=this.$(".mapcanvas").is(":visible");$(".extended-info").hide(),$(".mapcanvas").hide(),$(".arrow > img").attr("src","./img/arrow-down.png"),b||(v.MapView.clear(),v.MapView.createStopMarker(this.options.stop),v.MapView.createBusMarker(this.model),this.resize(!0),this.$(".mapcanvas").html(v.MapView.el),this.$(".arrow > img").attr("src","./img/arrow-up.png"),this.$(".extended-info").show(),this.$(".mapcanvas").show(),v.MapView.resize(),v.MapView.setBounds(),a&&$("html,body").animate({scrollTop:this.$el.offset().top-50},"slow"))},resize:function(a){var b=this.$(".mapcanvas").is(":visible");if(a||b){var c=$(".schedule").height(),d=$(".navbar").height(),e=$(".stop-name").height(),f=$(".head-label").height(),g=window.innerHeight-(d+c+e+f+6);v.MapView.$el.height(g),v.MapView.resize(),v.MapView.setBounds()}}}),l=function(a){var b=function(){a(u),$("#geolocation-failed").prependTo("#stops").fadeIn()},c=setTimeout(b,5e3),d=function(b){clearTimeout(c),a(new google.maps.LatLng(b.coords.latitude,b.coords.longitude))};navigator.geolocation?navigator.geolocation.getCurrentPosition(d,b):b()},m=Backbone.View.extend({template:_.template($("#stop-list-template").html()),events:{"click .loadMore":"forceRefresh"},initialize:function(){_.bindAll(this),l(this.getStopList)},forceRefresh:function(){v.ContentView.trigger("forceRefresh"),$("html,body").animate({scrollTop:this.$el.offset().top-60},"slow")},getStopList:function(a){this.render();var b=new e;b.location=a;new h({el:this.$("#stops"),collection:b})},render:function(){return this.$el.html(this.template()),this}}),n=Backbone.View.extend({id:"stops",initialize:function(){var a=new e;a.stopIds=this.options.stopIds;new h({el:this.el,collection:a})}}),o=Backbone.View.extend({id:"route-view",template:_.template($("#route-view-template").html()),events:{"change #route":"routeSelected"},initialize:function(){this.firstUpdate=!0,this.collection=new f({},{routeIds:this.options.routeIds}),this.collection.on("reset",this.addBuses,this),this.activeRoutesList=new g,this.activeRoutesList.on("reset",this.render,this),this.activeRoutesList.fetch({reset:!0,dataType:"jsonp"}),this.updateBuses(),v.Intervals.push(setInterval($.proxy(this.updateBuses,this),3e4)),$(window).resize($.proxy(this.resize,this))},render:function(){return this.$el.html(this.template({routes:this.activeRoutesList.toJSON()})),this.setSelectedRoutes(this.options.routeIds&&this.options.routeIds.split("/")),v.MapView.$el.height(window.innerHeight-$(".navbar").outerHeight(!0)-this.$("select").outerHeight(!0)-10),this.$(".mapcanvas").html(v.MapView.el),this.$(".mapcanvas").show(),v.MapView.resize(),this},resize:function(){v.MapView.$el.height(window.innerHeight-$(".navbar").outerHeight(!0)-this.$("select").outerHeight(!0)-10),v.MapView.resize(),v.MapView.setBounds()},addBuses:function(){v.MapView.clear(),v.MapView.createUserMarker(u),this.collection.each(function(a){v.MapView.createBusMarker(a)}),v.MapView.resize(),this.firstUpdate&&(v.MapView.setBounds(),this.firstUpdate=!1)},updateBuses:function(){this.collection.fetch({reset:!0,dataType:"jsonp"})},routeSelected:function(){v.Router.navigate("routes/"+this.$("select option:selected").val(),{trigger:!0})},setSelectedRoutes:function(a){if(null==a||""==a)return this.$("select option")[0].selected=!0,void 0;var b=a.indexOf("");-1!=b&&a.splice(b,1),this.$("select option").each(function(b,c){c.selected=-1!=a.indexOf(c.value)})}}),p=Backbone.View.extend({id:"find-stops-view",template:_.template($("#find-stops-view-template").html()),events:{"click #locate":"locate","click #search":"search"},initialize:function(){this.collection=new Backbone.Collection([],{model:b}),this.collection.on("add",this.addStop,this),this.collection.once("sync",function(){v.MapView.setBounds()},this),v.MapView.clear(),v.MapView.setOnCenterChangedEvent($.proxy(this.findClosestStops,this)),$(window).resize($.proxy(this.resize,this)),this.options.location?v.ContentView.once("contentChanged",function(){this.onUserLocated(this.options.location)},this):this.locate()},render:function(){return this.$el.html(this.template()),this.resize(),this.$(".mapcanvas").html(v.MapView.el),this.$(".mapcanvas").show(),this},resize:function(){v.MapView.$el.height(window.innerHeight-$(".navbar").outerHeight(!0)-this.$("#find-options").outerHeight(!0)),v.MapView.resize(),v.MapView.setBounds()},addStop:function(a){v.MapView.createStopMarker(a,!0,function(){v.Router.navigate("stops/"+a.get("stopId"),{trigger:!0})})},findClosestStops:function(a){v.Router.navigate("findStops/"+a.lat()+"/"+a.lng()+"/"),this.collection.url=c+"stops/near/"+a.lat()+"/"+a.lng()+"/",this.collection.fetch({remove:!1,dataType:"jsonp"})},locate:function(){l($.proxy(this.onUserLocated,this))},onUserLocated:function(a){v.Router.navigate("findStops/"+a.lat()+"/"+a.lng()+"/"),v.MapView.createUserMarker(a,!0),v.MapView.resize(),v.MapView.center(a),v.MapView.zoom(17),this.findClosestStops(a)},search:function(){var a=this.$("#intersection").val(),b=this.$("#city").val();""!=a&&(v.MapView.clear(),this.collection.once("sync",this.onSearchFinished,this),this.collection.url=c+"stops/near/intersection/"+b+"/"+a+"/",this.collection.fetch({dataType:"jsonp"}))},onSearchFinished:function(){v.MapView.setBounds();var a=v.MapView.center();v.Router.navigate("findStops/"+a.lat()+"/"+a.lng()+"/")}}),q=Backbone.View.extend({tagName:"div",template:_.template($("#user-feedback-template").html()),render:function(){return this.$el.html(this.template()),this}}),r=Backbone.View.extend({el:$(".app-container"),initialize:function(){$("#jPanelMenu-menu").click(function(){t.close()})},setSubView:function(a){this.subView&&this.subView.remove(),this.subView=a,this.$el.html(this.subView.render().el),this.$el.trigger("create"),this.trigger("contentChanged")}}),s=Backbone.Router.extend({routes:{"":"homeView","stops/*stopIds":"stopView","routes(/*routeIds)":"routeView","findStops(/:lat/:lng)(/)":"findStopsView","feedback(/)":"feedbackView"},homeView:function(){this.clearIntervals(),v.ContentView.setSubView(new m),v.MapView.setDraggable(!1)},stopView:function(a){this.clearIntervals(),v.ContentView.setSubView(new n({stopIds:a})),v.MapView.setDraggable(!1)},routeView:function(a){this.clearIntervals(),v.ContentView.setSubView(new o({routeIds:a})),v.MapView.setDraggable(!0),$("#loading").remove()},findStopsView:function(a,b){this.clearIntervals();var c=a&&b&&new google.maps.LatLng(a,b);v.ContentView.setSubView(new p({location:c})),v.MapView.setDraggable(!0),$("#loading").remove()},feedbackView:function(){this.clearIntervals(),v.ContentView.setSubView(new q),console.log("were you trying to go to feedback?")},clearIntervals:function(){for($(window).off("resize");v.Intervals.length;)clearInterval(v.Intervals.pop())}});Number.prototype.mod=function(a){return(this%a+a)%a},Date.prototype.addHours=function(a){return this.setHours(this.getHours()+a),this},Date.prototype.addMinutes=function(a){return this.setMinutes(this.getMinutes()+a),this},Date.prototype.to12HourString=function(){var a="AM",b=this.getHours(),c=this.getMinutes();return b>=12&&(b-=12,a="PM"),0==b&&(b=12),c=10>c?"0"+c:c,b+":"+c+" "+a},Date.parseUtc=function(a){var b=a.match(/(\d+)/g);return Date.UTC(b[0],b[1]-1,b[2],b[3],b[4],b[5])};var t=$.jPanelMenu({direction:"right",excludedPanelContent:"style, script, #disclaimer"});t.on();var u=new google.maps.LatLng(36.863794,-76.285608),v={ContentView:new r,Router:new s,MapView:new j,Intervals:[]};v.Router.on("route",function(){_gaq.push(["_trackPageview",location.pathname+location.hash])});var w=-1==document.URL.indexOf("/hrt-bus-finder")?"/":"/hrt-bus-finder/";Backbone.history.start({root:w})}),window.Modernizr=function(a,b,c){function d(a){o.cssText=a}function e(a,b){return typeof a===b}var f,g,h,i="2.6.3",j={},k=!0,l=b.documentElement,m="modernizr",n=b.createElement(m),o=n.style,p=({}.toString,{}),q=[],r=q.slice,s={}.hasOwnProperty;h=e(s,"undefined")||e(s.call,"undefined")?function(a,b){return b in a&&e(a.constructor.prototype[b],"undefined")}:function(a,b){return s.call(a,b)},Function.prototype.bind||(Function.prototype.bind=function(a){var b=this;if("function"!=typeof b)throw new TypeError;var c=r.call(arguments,1),d=function(){if(this instanceof d){var e=function(){};e.prototype=b.prototype;var f=new e,g=b.apply(f,c.concat(r.call(arguments)));return Object(g)===g?g:f}return b.apply(a,c.concat(r.call(arguments)))};return d});for(var t in p)h(p,t)&&(g=t.toLowerCase(),j[g]=p[t](),q.push((j[g]?"":"no-")+g));return j.addTest=function(a,b){if("object"==typeof a)for(var d in a)h(a,d)&&j.addTest(d,a[d]);else{if(a=a.toLowerCase(),j[a]!==c)return j;b="function"==typeof b?b():b,"undefined"!=typeof k&&k&&(l.className+=" "+(b?"":"no-")+a),j[a]=b}return j},d(""),n=f=null,function(a,b){function c(a,b){var c=a.createElement("p"),d=a.getElementsByTagName("head")[0]||a.documentElement;return c.innerHTML="x<style>"+b+"</style>",d.insertBefore(c.lastChild,d.firstChild)}function d(){var a=r.elements;return"string"==typeof a?a.split(" "):a}function e(a){var b=q[a[o]];return b||(b={},p++,a[o]=p,q[p]=b),b}function f(a,c,d){if(c||(c=b),k)return c.createElement(a);d||(d=e(c));var f;return f=d.cache[a]?d.cache[a].cloneNode():n.test(a)?(d.cache[a]=d.createElem(a)).cloneNode():d.createElem(a),f.canHaveChildren&&!m.test(a)?d.frag.appendChild(f):f}function g(a,c){if(a||(a=b),k)return a.createDocumentFragment();c=c||e(a);for(var f=c.frag.cloneNode(),g=0,h=d(),i=h.length;i>g;g++)f.createElement(h[g]);return f}function h(a,b){b.cache||(b.cache={},b.createElem=a.createElement,b.createFrag=a.createDocumentFragment,b.frag=b.createFrag()),a.createElement=function(c){return r.shivMethods?f(c,a,b):b.createElem(c)},a.createDocumentFragment=Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+d().join().replace(/\w+/g,function(a){return b.createElem(a),b.frag.createElement(a),'c("'+a+'")'})+");return n}")(r,b.frag)}function i(a){a||(a=b);var d=e(a);return r.shivCSS&&!j&&!d.hasCSS&&(d.hasCSS=!!c(a,"article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}mark{background:#FF0;color:#000}")),k||h(a,d),a}var j,k,l=a.html5||{},m=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,n=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,o="_html5shiv",p=0,q={};!function(){try{var a=b.createElement("a");a.innerHTML="<xyz></xyz>",j="hidden"in a,k=1==a.childNodes.length||function(){b.createElement("a");var a=b.createDocumentFragment();return"undefined"==typeof a.cloneNode||"undefined"==typeof a.createDocumentFragment||"undefined"==typeof a.createElement}()}catch(c){j=!0,k=!0}}();var r={elements:l.elements||"abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video",shivCSS:l.shivCSS!==!1,supportsUnknownElements:k,shivMethods:l.shivMethods!==!1,type:"default",shivDocument:i,createElement:f,createDocumentFragment:g};a.html5=r,i(b)}(this,b),j._version=i,l.className=l.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(k?" js "+q.join(" "):""),j}(this,this.document),function(a,b,c){function d(a){return"[object Function]"==q.call(a)}function e(a){return"string"==typeof a}function f(){}function g(a){return!a||"loaded"==a||"complete"==a||"uninitialized"==a}function h(){var a=r.shift();s=1,a?a.t?o(function(){("c"==a.t?m.injectCss:m.injectJs)(a.s,0,a.a,a.x,a.e,1)},0):(a(),h()):s=0}function i(a,c,d,e,f,i,j){function k(b){if(!n&&g(l.readyState)&&(t.r=n=1,!s&&h(),l.onload=l.onreadystatechange=null,b)){"img"!=a&&o(function(){v.removeChild(l)},50);for(var d in A[c])A[c].hasOwnProperty(d)&&A[c][d].onload()}}var j=j||m.errorTimeout,l=b.createElement(a),n=0,q=0,t={t:d,s:c,e:f,a:i,x:j};1===A[c]&&(q=1,A[c]=[]),"object"==a?l.data=c:(l.src=c,l.type=a),l.width=l.height="0",l.onerror=l.onload=l.onreadystatechange=function(){k.call(this,q)},r.splice(e,0,t),"img"!=a&&(q||2===A[c]?(v.insertBefore(l,u?null:p),o(k,j)):A[c].push(l))}function j(a,b,c,d,f){return s=0,b=b||"j",e(a)?i("c"==b?x:w,a,b,this.i++,c,d,f):(r.splice(this.i++,0,a),1==r.length&&h()),this}function k(){var a=m;return a.loader={load:j,i:0},a}var l,m,n=b.documentElement,o=a.setTimeout,p=b.getElementsByTagName("script")[0],q={}.toString,r=[],s=0,t="MozAppearance"in n.style,u=t&&!!b.createRange().compareNode,v=u?n:p.parentNode,n=a.opera&&"[object Opera]"==q.call(a.opera),n=!!b.attachEvent&&!n,w=t?"object":n?"script":"img",x=n?"script":w,y=Array.isArray||function(a){return"[object Array]"==q.call(a)},z=[],A={},B={timeout:function(a,b){return b.length&&(a.timeout=b[0]),a}};m=function(a){function b(a){var b,c,d,a=a.split("!"),e=z.length,f=a.pop(),g=a.length,f={url:f,origUrl:f,prefixes:a};for(c=0;g>c;c++)d=a[c].split("="),(b=B[d.shift()])&&(f=b(f,d));for(c=0;e>c;c++)f=z[c](f);return f}function g(a,e,f,g,h){var i=b(a),j=i.autoCallback;i.url.split(".").pop().split("?").shift(),i.bypass||(e&&(e=d(e)?e:e[a]||e[g]||e[a.split("/").pop().split("?")[0]]),i.instead?i.instead(a,e,f,g,h):(A[i.url]?i.noexec=!0:A[i.url]=1,f.load(i.url,i.forceCSS||!i.forceJS&&"css"==i.url.split(".").pop().split("?").shift()?"c":c,i.noexec,i.attrs,i.timeout),(d(e)||d(j))&&f.load(function(){k(),e&&e(i.origUrl,h,g),j&&j(i.origUrl,h,g),A[i.url]=2})))}function h(a,b){function c(a,c){if(a){if(e(a))c||(l=function(){var a=[].slice.call(arguments);m.apply(this,a),n()}),g(a,l,b,0,j);else if(Object(a)===a)for(i in h=function(){var b,c=0;for(b in a)a.hasOwnProperty(b)&&c++;return c}(),a)a.hasOwnProperty(i)&&(!c&&!--h&&(d(l)?l=function(){var a=[].slice.call(arguments);m.apply(this,a),n()}:l[i]=function(a){return function(){var b=[].slice.call(arguments);a&&a.apply(this,b),n()}}(m[i])),g(a[i],l,b,i,j))}else!c&&n()}var h,i,j=!!a.test,k=a.load||a.both,l=a.callback||f,m=l,n=a.complete||f;c(j?a.yep:a.nope,!!k),k&&c(k)}var i,j,l=this.yepnope.loader;if(e(a))g(a,0,l,0);else if(y(a))for(i=0;i<a.length;i++)j=a[i],e(j)?g(j,0,l,0):y(j)?m(j):Object(j)===j&&h(j,l);else Object(a)===a&&h(a,l)},m.addPrefix=function(a,b){B[a]=b},m.addFilter=function(a){z.push(a)},m.errorTimeout=1e4,null==b.readyState&&b.addEventListener&&(b.readyState="loading",b.addEventListener("DOMContentLoaded",l=function(){b.removeEventListener("DOMContentLoaded",l,0),b.readyState="complete"},0)),a.yepnope=k(),a.yepnope.executeStack=h,a.yepnope.injectJs=function(a,c,d,e,i,j){var k,l,n=b.createElement("script"),e=e||m.errorTimeout;n.src=a;for(l in d)n.setAttribute(l,d[l]);c=j?h:c||f,n.onreadystatechange=n.onload=function(){!k&&g(n.readyState)&&(k=1,c(),n.onload=n.onreadystatechange=null)},o(function(){k||(k=1,c(1))},e),i?n.onload():p.parentNode.insertBefore(n,p)},a.yepnope.injectCss=function(a,c,d,e,g,i){var j,e=b.createElement("link"),c=i?h:c||f;e.href=a,e.rel="stylesheet",e.type="text/css";for(j in d)e.setAttribute(j,d[j]);g||(p.parentNode.insertBefore(e,p),o(c,0))}}(this,document),Modernizr.load=function(){yepnope.apply(window,[].slice.call(arguments,0))};